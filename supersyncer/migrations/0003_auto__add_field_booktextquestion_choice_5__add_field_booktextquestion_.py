...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BookTextQuestion.choice_5'
        db.add_column('supersyncer_booktextquestion', 'choice_5',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BookTextQuestion.choice_6'
        db.add_column('supersyncer_booktextquestion', 'choice_6',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BookTextQuestion.choice_5'
        db.delete_column('supersyncer_booktextquestion', 'choice_5')

        # Deleting field 'BookTextQuestion.choice_6'
        db.delete_column('supersyncer_booktextquestion', 'choice_6')
