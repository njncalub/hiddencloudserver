...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BookText.deleted'
        db.add_column('supersyncer_booktext', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BookTextQuestion.deleted'
        db.add_column('supersyncer_booktextquestion', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BookText.deleted'
        db.delete_column('supersyncer_booktext', 'deleted')

        # Deleting field 'BookTextQuestion.deleted'
        db.delete_column('supersyncer_booktextquestion', 'deleted')
