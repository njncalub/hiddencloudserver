...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Survey'
        db.create_table('supersyncer_survey', (
            ...
            ('q_enjoy_reading', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('q_want_to_improve', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('q_like_visuals', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('q_like_music', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('q_like_story', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('q_continue_playing', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('q_find_way_easily', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('q_gets_difficult', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('q_good_rewards', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('q_relevant_feedback', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('q_game_helped', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('q_recommend_to_friends', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('s_awpm', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('s_rc', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('supersyncer', ['Survey'])


    def backwards(self, orm):
        # Deleting model 'Survey'
        db.delete_table('supersyncer_survey')
    ...
    models = {
        ...
        'supersyncer.survey': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'q_continue_playing': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'q_enjoy_reading': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'q_find_way_easily': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'q_game_helped': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'q_gets_difficult': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'q_good_rewards': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'q_like_music': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'q_like_story': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'q_like_visuals': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'q_recommend_to_friends': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'q_relevant_feedback': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'q_want_to_improve': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            's_awpm': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            's_rc': ('django.db.models.fields.FloatField', [], {'default': '0.0', 'null': 'True', 'blank': 'True'}),
