...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GameResult.b_awpm'
        db.add_column('supersyncer_gameresult', 'b_awpm',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GameResult.b_awpm'
        db.delete_column('supersyncer_gameresult', 'b_awpm')
    ...
    models = {
        ...
        'supersyncer.gameresult': {
            ...
            'b_awpm': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
